...
public class ProfilActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        session = new CodezSession(ProfilActivity.this);
        ...
        usernamePageProfil = findViewById(R.id.UsernamePageProfil);
        usernamePageProfil.setText(session.getUserName());
    ...
    public void modifierUsername(View view) {
        editTextUpdateUsername = findViewById(R.id.editTextUpdateUsername);
        String newUsername = editTextUpdateUsername.getText().toString();
        usernamePageProfil = findViewById(R.id.UsernamePageProfil);
        usernamePageProfil.setText(newUsername);
        if (session.isUserLogedIn() == true) {
            NavigationView navigationView = (NavigationView) findViewById(R.id.nav_view);
            View headerView = navigationView.getHeaderView(0);
            TextView navUsername = (TextView) headerView.findViewById(R.id.textViewUsername);
            navUsername.setText(newUsername);
        }
    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && data != null) {
            ...
            imageProfilView.setImageURI(selectedImage);
        }
    }
